...
struct AppColor {
    ...
    static let cBrightRed: Color = Color("cBrightRed")
    static let cOrange: Color = Color("cOrange")
    static let cPurple: Color = Color("cPurple")
    static let cPurpleBlue: Color = Color("cPurpleBlue")
